...
export function createTiesAndSlursDemo() {
    ...
    doc.addMeasure()
        ...
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up, slurSpan: 2, slurPos: Score.ArcPos.Below })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up })
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down, slurSpan: 2, slurPos: Score.ArcPos.Below })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down });

    doc.addMeasure()
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up, slurSpan: 2, slurPos: Score.ArcPos.Above })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up })
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down, slurSpan: 2, slurPos: Score.ArcPos.Above })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down });

    doc.addMeasure()
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up, slurSpan: 2, slurPos: Score.ArcPos.Middle })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up })
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down, slurSpan: 2, slurPos: Score.ArcPos.Middle })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down });

    doc.addMeasure()
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up, slurSpan: 2, slurPos: Score.ArcPos.StemTip })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Up })
        .addNote(0, "G4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down, slurSpan: 2, slurPos: Score.ArcPos.StemTip })
        .addNote(0, "A4", Theory.NoteLength.Quarter, { stem: Score.Stem.Down })
        .endRow();
    ...
    doc.addMeasure()
        .addNote(1, "D4", Theory.NoteLength.Half, { dotted: true, tieSpan: 2, tiePos: Score.ArcPos.Below, stem: Score.Stem.Down })
    ...
    doc.addMeasure()
        ...
        .addNote(1, "A3", Theory.NoteLength.Quarter, { stem: Score.Stem.Down, tieSpan: Score.TieLength.Short, tiePos: Score.ArcPos.Below })
    ...
    doc.addMeasure()
        ...
        .addNote(0, "A4", Theory.NoteLength.Eighth)
        .addNote(0, "B4", Theory.NoteLength.Eighth, { tieSpan: Score.TieLength.ToMeasureEnd })
        .addNote(0, "C5", Theory.NoteLength.Eighth, { tieSpan: Score.TieLength.ToMeasureEnd })
        .addNote(0, "E5", Theory.NoteLength.Eighth, { tieSpan: Score.TieLength.ToMeasureEnd })
        .addNote(1, "A3", Theory.NoteLength.Half, { dotted: true, tieSpan: 2, tiePos: Score.ArcPos.Below })
