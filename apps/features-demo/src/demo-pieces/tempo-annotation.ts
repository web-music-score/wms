...
export function createTempoAnnotationDemo() {
    return new Score.DocumentBuilder()
        ...
        .addNote(0, "A3", Theory.NoteLength.Eighth).addAnnotation(Score.Annotation.Tempo, "accel.").addExtension(ext => ext.notes(Theory.NoteLength.Half))
        ...
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth).addAnnotation(Score.Annotation.Tempo, "rit.").addExtension(ext => ext.notes(Theory.NoteLength.Whole))
        .addNote(0, "G3", Theory.NoteLength.Eighth)
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        ...
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth).addAnnotation(Score.Annotation.Tempo, "accel.").addExtension(ext => ext.infinity().hide())
        .addNote(0, "G3", Theory.NoteLength.Eighth)
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth)
        ...
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth).addAnnotation(Score.Annotation.Tempo, "accel.").addExtension(ext => ext.notes(Theory.NoteLength.Whole, 3))
        .addNote(0, "G3", Theory.NoteLength.Eighth)
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth)
        ...
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth).addAnnotation(Score.Annotation.Tempo, "accel.").addExtension(ext => ext.measures(2))
        .addNote(0, "G3", Theory.NoteLength.Eighth)
        .addNote(0, "A3", Theory.NoteLength.Eighth)
        .addNote(0, "B3", Theory.NoteLength.Eighth)
        .addNote(0, "C4", Theory.NoteLength.Eighth)
