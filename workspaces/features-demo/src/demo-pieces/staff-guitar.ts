...
export function createStaffConfigGuitarDemo() {
    return new Score.DocumentBuilder()
        ...
        .addChord(0, ["E4", "C3"], "8n", { string: [1, 5] }).addAnnotation("C", { group: "chordLabel"})
        .addNote(0, "E3", "8n", { string: 4 })
        .addNote(0, "G3", "8n", { string: 3 })
        .addNote(0, "C4", "8n", { string: 2 })
        .addChord(0, ["D4", "G3", "F3", "C3"], "8n", { string: [2, 3, 4, 5] }).addAnnotation("Csus4", { group: "chordLabel"})
        .addNote(0, "C4", "8n", { string: 2 })
        .addNote(0, "C4", "8n")
        .addNote(0, "A3", "8n", { string: 3 })

        .addMeasure()
        .addChord(0, ["G3", "C3"], "8n", { string: [3, 5] }).addAnnotation("C", { group: "chordLabel"})
        .addNote(0, "C4", "8n", { string: 2 })
        .addNote(0, "E3", "8n", { string: 4 })
        .addNote(0, "G3", "8n", { string: 3 })
