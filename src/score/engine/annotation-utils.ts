...
const AnnotationKindToGroupMap = new UniMap<AnnotationKind, AnnotationGroup>([
    ...
    [AnnotationKind.cresc_hairpin, AnnotationGroup.Dynamics],
    [AnnotationKind.decresc_hairpin, AnnotationGroup.Dynamics],
    [AnnotationKind.dim_hairpin, AnnotationGroup.Dynamics],
