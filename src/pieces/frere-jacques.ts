...
export function createFrereJacques(): MDocument {
    return new DocumentBuilder()
        ...
        .addNote(0, "F#4", "4n").addLyrics(1, "4n", "sleep", { hyphen: "-" })
        ...
        .addNote(0, "F#4", "4n").addLyrics(1, "4n", "Bro", { hyphen: "-" })
        ...
        .addNote(1, "F#3", "4n").addLyricsTo(1, 1, "4n", "sleep", { hyphen: "-" })
        ...
        .addMeasure()
        .addNote(0, "A4", "8n").addLyrics(1, "8n", "Morn", { hyphen: "-" })
        .addNote(0, "B4", "8n").addLyrics(1, "8n", "ing")
        .addNote(0, "A4", "8n").addLyrics(1, "8n", "bells")
        .addNote(0, "G4", "8n").addLyrics(1, "8n", "are")
        .addNote(0, "F#4", "4n").addLyrics(1, "4n", "ring", { hyphen: "-" })
        .addNote(0, "D4", "4n").addLyrics(1, "4n", "ing!")
        .addNote(1, "F#3", "4n").addLyricsTo(1, 1, "4n", "Bro", { hyphen: "-" })
        ...
        .addNote(0, "C#4", "8n").addLyrics(1, "8n", "A", { hyphen: "-" })
