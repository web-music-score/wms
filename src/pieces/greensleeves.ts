...
export function createGreensleeves(): MDocument {
    return new DocumentBuilder()
        ...
        .addMeasure()
        .addNote(0, "D4", "4n", { stem: "up" }).addAnnotation("chordLabel", "G")
        .addNote(0, "B3", "8n")
        .addNote(0, "G3", "8.").addAnnotation("chordLabel", "Em")
        .addNote(0, "A3", "16n")
        .addNote(0, "B3", "8n")
        ...
        .addNote(0, "A3", "8n")
        .addNote(0, "A3", "8.").addAnnotation("chordLabel", "F")
        .addNote(0, "G#3", "16n")
        .addNote(0, "A3", "8n")
        .addNote(1, "A2", "8n", { stem: "down" })
        .addNote(1, "E3", "4n")
        ...
        .addMeasure()
        .addNote(0, "B3", "4n", { stem: "up" }).addAnnotation("chordLabel", "E")
        .addNote(0, "G#3", "8n")
        .addNote(0, "E3", "4n")
        .addNote(0, "A3", "8n")
        ...
        .addMeasure()
        .addNote(0, "C4", "8.", { stem: "up" }).addAnnotation("chordLabel", "Am")
        .addNote(0, "B3", "16n")
        .addNote(0, "A3", "8n")
        .addNote(0, "G#3", "8.").addAnnotation("chordLabel", "E")
        .addNote(0, "F#3", "16n")
        .addNote(0, "G#3", "8n")
        .addNote(1, "A2", "8n", { stem: "down" })
        .addNote(1, "E3", "4n")
        ...
        .addMeasure()
        .addNote(0, "A3", "4.", { stem: "up" }).addAnnotation("chordLabel", "Am")
        .addNote(0, "A3", "4.")
        .addNote(1, "A2", "8n", { stem: "down" })
        .addNote(1, "E3", "8n")
        .addNote(1, "C4", "8n")
        ...
        .addMeasure()
        .addChord(0, ["C3", "E3", "G3", "C4", "G4"], "4.", { arpeggio: "up", stem: "up" }).addAnnotation("chordLabel", "C")
        .addNote(0, "G4", "8.")
        .addNote(0, "F#4", "16n")
        .addNote(0, "E4", "8n")
        ...
        .addMeasure()
        .addNote(0, "G4", "4.", { stem: "up" }).addAnnotation("chordLabel", "C")
        .addNote(0, "G4", "8.")
        .addNote(0, "F#4", "16n")
        .addNote(0, "E4", "8n")
        .addNote(1, "C3", "8n", { stem: "down" })
